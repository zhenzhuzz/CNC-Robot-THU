...
function m054_CustomSpinSpeed_Decision_NI_Spindle_TCPIP_GUI_04()
    %% 初始化参数
    ...
    customSpeedButton.Layout.Column = 3;
    ...
    function sendSpindleCmd()
        % 修正发送的targetSpeed为round(targetSpeed*slope+intercept)
        if isSpindleConnected
