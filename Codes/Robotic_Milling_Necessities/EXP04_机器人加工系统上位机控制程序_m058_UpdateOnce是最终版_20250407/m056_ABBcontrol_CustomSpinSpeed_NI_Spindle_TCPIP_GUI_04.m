%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% m056_ABBcontrol_CustomSpinSpeed_NI_Spindle_TCPIP_GUI_04.m
%
% 说明：
...
function m056_ABBcontrol_CustomSpinSpeed_NI_Spindle_TCPIP_GUI_04()
    %% 初始化参数
    ...
    %% 第二行：按钮区域（共1行6列）
    btnLayout = uigridlayout(mainLayout, [1,6]);
    btnLayout.RowHeight = {'1x'};
    btnLayout.ColumnWidth = {'1x','1x','1x','1x','1x','1x'};
