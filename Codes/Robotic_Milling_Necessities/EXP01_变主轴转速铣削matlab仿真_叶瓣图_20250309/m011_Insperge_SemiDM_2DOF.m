...
%%  parameters
N=4; % number of teeth
Kt=600e6; % tangential cutting force coefficient(N/m2)
Kn=42e6; % normal cutting force coefficient(N/m2)
w0x=600*2*pi; % angular natural frequency x (rad/s)
zetax=0.035; % relative damping x (1)
w0y=660*2*pi; % angular natural frequency y (rad/s)
zetay=0.035; % relative damping y (1)
m_tx  = 5.6e6 / ((2*pi*600)^2);   % mass x (kg)
m_ty  = 5.6e6 / ((2*pi*660)^2);   % mass y (kg)
...
stx=100; % steps of spindle speed
...
o_fi=15e3; % final spindle speed (rpm)
