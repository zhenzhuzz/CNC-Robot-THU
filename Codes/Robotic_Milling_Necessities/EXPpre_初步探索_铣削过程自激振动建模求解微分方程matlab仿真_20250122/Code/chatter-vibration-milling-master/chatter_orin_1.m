...
xi_x = 0.68; % damping ratio in x dirn
xi_y = 2.1; % damping ratio in y dirn
omega_nx = 540.08; % natural frequency in Hz (x compnt)
omega_ny = 543.67; % natural frequency in Hz (y compnt)
kx = 1.15885e7; % stiffness in N/m
...
a = 1; % axial depth of cut, ADOC in mm
