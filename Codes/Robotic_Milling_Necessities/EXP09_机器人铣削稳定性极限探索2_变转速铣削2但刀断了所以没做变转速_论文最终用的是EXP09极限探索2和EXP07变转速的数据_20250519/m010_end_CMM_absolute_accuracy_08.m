...
file  = 'cmm_09/4000_end.txt';            % 数据文件名 / data file name
...
if numel(z_actual) ~= 300
    error('z_actual length should be 300, but is %d.', numel(z_actual));
end
z_matrix = reshape(z_actual, 30, 10)';  % 先按列填充为20×5，再转置为5×20 / reshape to 5×20
