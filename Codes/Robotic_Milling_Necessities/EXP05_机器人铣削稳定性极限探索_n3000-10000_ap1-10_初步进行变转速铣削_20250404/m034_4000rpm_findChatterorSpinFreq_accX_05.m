...
f030_optimizeFig_Paper_05(ax1, '{\it t} (s)', '{\it a_x} (g)','','tight',[-2 2]);
...
f030_optimizeFig_Paper_05(ax2, '{\it f} (Hz)', '|X(\it f)|', '',[0 2000],[0 0.3]);
f032_legend_05(ax2,{'{\it f}_{SP}'},'FontName','Times New Roman')
