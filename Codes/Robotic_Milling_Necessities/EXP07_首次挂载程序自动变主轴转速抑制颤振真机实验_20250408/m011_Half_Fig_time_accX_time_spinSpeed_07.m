...
figure('Units','centimeters','Position',[5 1 7.5 20]);
...
hold on;
xline([15.8 16.8 18.3 19.8 20.1],'r--','LineWidth',0.8);
f030_optimizeFig_Paper_07(ax1, '{\it t} (s)', '', '',[15 21],'tight');

ax2 = subplot(5, 1, 2);
plot(ax2, timestamps, isChatter,'LineWidth',1.3);
hold on;
xline([15.8 16.8 18.3 19.8 20.1],'r--','LineWidth',0.8);
f030_optimizeFig_Paper_07(ax2, '{\it t} (s)', '', '',[15 21],[-0.5,1.5]);

ax3 = subplot(5, 1, 3);
plot(ax3, timestamps, fc,'LineWidth',1.3);
hold on;
xline([15.8 16.8 18.3 19.8 20.1],'r--','LineWidth',0.8);
f030_optimizeFig_Paper_07(ax3, '{\it t} (s)', '', '',[15 21],[150 850]);
...
hold on;
xline([15.8 16.8 18.3 19.8 20.1],'r--','LineWidth',0.8);
f030_optimizeFig_Paper_07(ax4, '{\it t} (s)', '', '',[15 21],[4200 8300]);
...
hold on;
xline([15.8 16.8 18.3 19.8 20.1],'r--','LineWidth',0.8);
f030_optimizeFig_Paper_07(ax4, '{\it t} (s)', '', '', [15 21],[0 1000]);
